...
if(isset($_POST['submit'])){
	...
	if($count==0){
		...
		while($row = mysqli_fetch_array($result)){
			...
			$output .= '<table style="display:inline-flex" border = 1><tr><th>Name</th><th>Image</th><th>District</th><th>Description</th></tr><tr><td>'.$name.'</td><td>'.$file.'</td><td>'.$dist.'</td><td>'.$desc.'</td></tr></table>';
		}
	}
}
...
<html>
 <head>
   <title>travel karnataka</title>
    ...
    <div class="w3-top">
        <div class="top-bar w3-white w3-wide w3-padding w3-card">
        ...
        <a href="add.php" class="w3-bar-item w3-button"><i class="fa fa-camera-retro" style="font-size:12px; color:#ff545a"></i><span style="color:#ff545a;font-size:12px;">ADD PLACE</span></a>
	    ...
	    <div class="dropdown">
  <button class="dropbtn"><i class="fa fa-user" style="font-size:15px; color:#ff545a"></i><span style="color:#ff545a;font-size:12px;"><?php echo $_SESSION['email'];?> </button></span></a>
